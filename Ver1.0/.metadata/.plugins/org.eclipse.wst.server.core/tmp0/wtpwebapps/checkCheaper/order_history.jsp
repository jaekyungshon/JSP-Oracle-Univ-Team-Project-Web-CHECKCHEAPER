				      ...
				      <div class="card-body">
				        <table class="table" style="text-align:center;">
				        	...
				        	<tbody class="thead-light">
				        		...
				        		%>
				        		<tr><th scope="col" colspan="2">합 계(품목총가-멤버십할인혜택)</th><td colspan="2"><%=String.format("%d-%d=%d원",fi_total_price,membershipPrice,fi_total_price-membershipPrice<0 ? 0:fi_total_price-membershipPrice) %></td></tr>
				        		<tr>
